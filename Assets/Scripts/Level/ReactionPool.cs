...
public class ReactionPool : MonoBehaviour
{
    ...
    public List<MolChemical> GetMolChemicalsInReactionPool()
    {
        List<MolChemical> MolChemicalsInReactionPool = new List<MolChemical>();
        foreach (GameObject che in Chemicals)
        {
            MolChemicalsInReactionPool.Add(
                new MolChemical(
                    che.GetComponent<Chemicals>().ChemicalInclude, 
        ...
        return MolChemicalsInReactionPool;
    }
